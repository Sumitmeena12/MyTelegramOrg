...
OWNER_USERNAME = os.environ.get("OWNER_USERNAME", "Farzicoderxd")

keyboard = [[
            InlineKeyboardButton('My Developer', url=f"https://t.me/{@Farzicoderxd}"),
            InlineKeyboardButton('Source 👻', url="https://t.me/dragondpworld")
        ]]
